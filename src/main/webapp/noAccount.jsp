...
<!-- Center -->
<!-- Center - Thông báo xác nhận thành công -->
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card text-center shadow-lg p-3 mb-5 bg-white rounded">
                <div class="card-body">
                    <img src="https://img.icons8.com/color/96/000000/checked--v1.png" alt="Success Icon" class="mb-3"/>
                    <h3 class="card-title text-success">Thông báo!</h3>
                    <p class="card-text mt-3">Bạn chưa đăng nhập vào hệ thống của chúng tôi. Vì thế bạn hãy đăng nhập để có thể truy cập và sử dụng tất cả các tính năng của chúng tôi.</p>
                    <a href="login-form.jsp" class="btn btn-success btn-lg mt-4">Đăng nhập ngay</a>
                </div>
            </div>
        </div>
    </div>
