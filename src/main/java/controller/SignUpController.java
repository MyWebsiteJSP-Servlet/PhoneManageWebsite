...
public class SignUpController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(error.length() > 0) {
				...
				User user = new User(userID, userName, passWord, email, phone, new Roles(2, "Khách hàng"), Date.valueOf(dateOfBitrh), sex, addRess, Date.valueOf(createAt), image);
	...
	private String getNoiDung(User user) {
		// TODO Auto-generated method stub
		String link = "http://localhost:8080/MobileWebApp/xac-thuc&maKhachHang="+user.getUserID()+"&maXacThuc="+user.getAuthenticationCode();
